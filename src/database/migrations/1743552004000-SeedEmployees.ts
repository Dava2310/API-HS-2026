...
const employees: EmployeeSeed[] = [
  ...
  {
    fullName: 'Stephanie Robinson',
    employeeCode: 'EMP0000017',
  ...
  { fullName: 'Andrew Clark', employeeCode: 'EMP0000018', email: 'andrew.clark@company.com', roleCode: 'it_staff' },
  {
    ...
    employeeCode: 'EMP0000019',
    email: 'melissa.rodriguez@company.com',
    roleCode: 'it_staff',
  },
  ...
  {
    fullName: 'Brittany Walker',
    employeeCode: 'EMP0000022',
    email: 'brittany.walker@company.com',
    roleCode: 'finance',
  },
...
export class SeedEmployees1743552004000 implements MigrationInterface {
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DELETE FROM employee WHERE employee_code = ANY($1)`, [codes]);
  }
}
